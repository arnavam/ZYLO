...
# ---- Force phonemizer to use eSpeak executable on Windows ----
from phonemizer.backend.espeak.espeak import EspeakBackend
EspeakBackend.executable = r"C:\Program Files\eSpeak NG\espeak.exe"
print("✔ Forced eSpeak backend path loaded")
...
def detect_mispronunciation(expected_text, audio_path):
    ...
    if score > THRESHOLD:
        print("⚠ Result: MISPRONOUNCED")
    else:
        print("✅ Result: PRONUNCIATION OK")
